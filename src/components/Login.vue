<template>
	<div v-if="callStatus === true" class="modal fade gv_log_pop in" id="loginLayer" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: block; padding-right: 15px;">
			...
			<div class="modal-content">
				...
				<div class="modal-header" style="padding:29px 15px 5px 15px; position:relative;">
					...
					<div style="border-bottom:2px solid #abad36;">
		            	<h4 class="login"><img src="/images/icon/icon_login.png">로그인</h4>
		            </div>
				</div>
				...
				<div class="modal-body G_log" id="myModalBody">
		            ...
		            <div class="sub-area">
						...
						<div style="text-align: center; display: none;" class="rechapca">
							<div id="html_element"><div style="width: 304px; height: 78px;"><div><iframe src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LfHaw8UAAAAAKORsphWWKXjYLK8kow5qJeSoI8W&amp;co=aHR0cDovL3d3dy5ncm9vdmVycy5rcjo4MA..&amp;hl=ko&amp;v=v1542004393985&amp;theme=light&amp;size=normal&amp;cb=gvs01j50fkyj" width="304" height="78" role="presentation" name="a-ce1wwlf4mwz1" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div><textarea id="g-recaptcha-response" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div></div>
